...
<html>
	...
	<body>
		<div class="col-md-8">
			...
			<hr>
			<p>
				<a href="http://localhost:8080/SuperMarket/addInvoice.htm"><button id="addMore" name="addMore" class="btn btn-success">Add More Invoice</button></a> <input type="button" value="Go Back From Where You Came!" onclick="history.back(-1)" class="btn btn-success"/>
			</p>
