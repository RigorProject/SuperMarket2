				...
				<fieldset>
					...
					<div class="form-group">
						<label class="col-md-4 control-label" for="appendedtext">Search
							Invoice</label> <a style="margin-left: 205px;"
							href="http://localhost:8080/SuperMarket/listInvoice"><span
			...
			<div class="panel panel-default">
				...
				<p>
					<a href="http://localhost:8080/SuperMarket/addInvoice.htm"><button
							...
							More Invoice</button></a> <input type="button"
						value="Go Back From Where You Came!" onclick="history.back(-1)"
